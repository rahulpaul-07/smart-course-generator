        ...
        <div className="divide-y divide-border/30">
          ...
          {leaders.length === 0 && (
            <EmptyState
              ...
              action={
                <button onClick={() => navigate('/dashboard#course-generator')} className="h-10 px-4 py-2 bg-primary text-primary-foreground hover:bg-primary/90 inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50">
                  Generate Course
                </button>
              }
