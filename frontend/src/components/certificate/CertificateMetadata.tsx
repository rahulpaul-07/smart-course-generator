...
export function CertificateMetadata({ certificate, issueDate, completionTime }: CertificateMetadataProps) {
  return (
    <div className="grid md:grid-cols-4 gap-4">
      <div className="md:col-span-1 bg-card border border-border rounded-2xl p-6 shadow-lg flex flex-col items-center justify-center text-center">
      ...
      <div className="md:col-span-3 bg-card border border-border rounded-2xl p-6 shadow-lg">
