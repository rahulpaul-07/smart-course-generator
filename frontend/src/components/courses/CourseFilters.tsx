...
export function CourseFilters({
  ...
  return (
    <motion.div 
      ...
      className="rounded-2xl border border-border bg-card p-4 shadow-sm flex flex-col xl:flex-row gap-4 items-center justify-between sticky top-20 z-30"
    >
      {/* Search */}
      <div className="relative w-full xl:w-[320px] shrink-0 group">
        ...
        <Input 
          ...
          className="w-full pl-10 h-11 rounded-xl bg-background/60 border-border focus-visible:ring-2 focus-visible:ring-primary shadow-inner font-medium placeholder:text-muted-foreground transition-all duration-200 hover:border-border"
      ...
      <div className="flex flex-col md:flex-row items-center gap-4 w-full xl:w-auto overflow-x-auto pb-2 xl:pb-0 scrollbar-none">
            ...
            <button
              ...
              className={`px-3.5 py-2 text-[13px] font-bold rounded-lg transition-all duration-200 whitespace-nowrap focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary ${
                filter === f 
                  ...
                  : 'bg-transparent border border-border text-muted-foreground hover:text-foreground hover:bg-muted/50 hover:border-border'
              }`}
        ...
        <div className="flex items-center justify-between w-full md:w-auto gap-3 shrink-0 border-t border-border md:border-t-0 md:border-l md:pl-4 pt-4 md:pt-0">
          {/* Sort Dropdown */}
          <div className="relative flex items-center gap-2 border border-border rounded-lg bg-background/60 px-3 h-10 hover:border-border transition-colors duration-200 focus-within:ring-2 focus-within:ring-primary focus-within:border-primary">
          ...
          {/* View Toggles */}
          <div className="flex bg-background/60 border border-border rounded-lg p-1 shrink-0">
            <button 
