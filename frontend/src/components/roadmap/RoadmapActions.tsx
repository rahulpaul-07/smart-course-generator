  ...
  return (
    <div className="rounded-2xl border border-border bg-card p-6 shadow-lg">
      ...
      <div className="space-y-2">
        <button onClick={() => navigate('/courses')} className="w-full flex items-center justify-between p-4 rounded-xl border border-border bg-background/50 hover:bg-muted hover:border-primary/30 transition-all group">
        ...
        <button onClick={() => navigate('/interview-prep')} className="w-full flex items-center justify-between p-4 rounded-xl border border-border bg-background/50 hover:bg-muted hover:border-success/30 transition-all group">
          <div className="flex items-center gap-3">
        ...
        <button onClick={() => navigate('/analytics')} className="w-full flex items-center justify-between p-4 rounded-xl border border-border bg-background/50 hover:bg-muted hover:border-primary/30 transition-all group">
          <div className="flex items-center gap-3">
            <div className="h-8 w-8 rounded-lg bg-primary/10 text-primary flex items-center justify-center">
