  ...
  return (
    <div className="rounded-2xl border border-border/30 bg-card/40 backdrop-blur-md p-6 shadow-lg">
      ...
      <div className="space-y-2">
        <button className="w-full flex items-center justify-between p-4 rounded-xl border border-border/30 bg-background/50 hover:bg-muted hover:border-primary/30 transition-all group">
        ...
        <button className="w-full flex items-center justify-between p-4 rounded-xl border border-border/30 bg-background/50 hover:bg-muted hover:border-cyan-500/30 transition-all group">
          <div className="flex items-center gap-3">
