...
export const ProductPreview = () => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto mt-20 relative z-10">
      ...
      <div className="relative rounded-[24px] border border-border/40 bg-background/80 backdrop-blur-2xl shadow-2xl overflow-hidden ring-1 ring-white/10 flex flex-col">
        {/* Browser Header */}
        <div className="h-12 border-b border-border/40 bg-muted/20 flex items-center px-4 gap-4">
          ...
          <div className="flex-1 max-w-md mx-auto bg-background/50 border border-border/40 h-7 rounded-md flex items-center px-3 justify-center shadow-inner">
        ...
        <div className="flex h-[450px]">
          {/* Sidebar */}
          <div className="w-16 md:w-56 border-r border-border/40 bg-muted/10 p-3 flex flex-col gap-2">
