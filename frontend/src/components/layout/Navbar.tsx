...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-30 border-b border-border bg-background/80 backdrop-blur-2xl">
      <div className="mx-auto flex h-[4.5rem] max-w-[96rem] items-center justify-between gap-4 px-4 lg:px-8">
        <button type="button" onClick={() => navigate('/')} className="group flex items-center gap-2.5 text-foreground">
              ...
              <button
                ...
                className={`flex items-center gap-1.5 rounded-lg px-3 py-2 text-xs font-medium transition ${
                  isActive
                    ...
                    : 'text-muted-foreground hover:bg-foreground/10 hover:text-foreground/90'
                }`}
              >
